...
using Abo.Server.Infrastructure.Persistence.EF.Mappings;
using Abo.Server.Infrastructure.Persistence.EF.Repositories;
...
namespace Abo.Server.Infrastructure.Persistence.EF
{
    public class UnitOfWork : DbContext, IUnitOfWork
    {
        ...
        internal IDbSet<User> Players { get; private set; }
