...
namespace Abo.Client.Core.Infrastructure.Proxies
{
    ...
    /// Autogenerated proxy for AppController
    /// </summary>
	public partial class BlacklistServiceProxy : ServiceProxyBase
	{
        public BlacklistServiceProxy(ConnectionManager connectionManager) : base(connectionManager)
        {
        }


		public Task<UserBlacklistResponse> GetBlacklist(UserBlacklistRequest request)
		{
			return ConnectionManager.SendRequestAndWaitResponse<UserBlacklistResponse>(request);
		}

		public Task<AddToBlacklistResponse> AddToBlacklist(AddToBlacklistRequest request)
		{
			return ConnectionManager.SendRequestAndWaitResponse<AddToBlacklistResponse>(request);
		}

		public Task<RemoveFromBlacklistResponse> RemoveFromBlacklist(RemoveFromBlacklistRequest request)
		{
			return ConnectionManager.SendRequestAndWaitResponse<RemoveFromBlacklistResponse>(request);
		}
